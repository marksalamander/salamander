    ...
    return (
        <section id="about" className={a.about}>
            ...
            <div className={a.description}>
                <p className={a.desc}>
                    Hello, my name is Mark Alexander. I am a senior at Towson University, passionate about learning new things. I am interested in all things programming, from web development to A.I.
                </p>
